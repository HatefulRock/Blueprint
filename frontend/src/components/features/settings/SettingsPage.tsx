...
import { useAuth, useSettings, useNavigation } from "../../../context";
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      if (res) {
        ...
        userService.addUserLanguage(opt).catch(() => null);
      }
    } catch (e) {
  ...
  const handleRemove = async (code: string) => {
    try {
      ...
      if (res) {
        ...
        userService.removeUserLanguage(code).catch(() => null);
      }
    } catch (e) {
  ...
  const handleSetDefault = async (code: string) => {
    try {
      ...
      if (res) {
        ...
        userService.setDefaultLanguage(code).catch(() => null);
      }
    } catch (e) {
